---
title: 每周见闻(44)：面对压力也是工作的一环
date: 2025-11-30 13:37:11
toc: true
---
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130223448653.jpeg)
...
## 工具
**1、[Six Things I Bet You Didn't Know You Could Do With Chrome's Devtools, Part 1](https://www.readwriterachel.com/things-i-learned/2025/11/09/devtools-1.html)[^1]**

标签：JavaScript,前端

介绍了 Chrome Devtools 中不太常见的功能的上篇。介绍了下面三个部分：
1. `console.time()` 和 `console.timeEnd()`：可以用来对定时器的问题进行调试
2. 任何 DOM 元素的监听方式：在 DOM 上的 Break On 菜单中可以显示
3. 浏览器中上下文监控：可以在第三方库上打断点，用来调试第三方库

![](https://www.readwriterachel.com/assets/devtools-main.png)

**2、[Six Things I Bet You Didn't Know You Could Do With Chrome's Devtools, Part 2](https://www.readwriterachel.com/things-i-learned/2025/11/17/devtools-2.html)[^3]**
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130134736194.png)

----

## 其他
**1、[写在 PicGo 即将 8 周年之际 - 少数派](https://sspai.com/post/104040)[^2]**
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130134840230.webp)

----

## Coding
**1、[GitHub - infinitered/gluegun: A delightful toolkit for building TypeScript-powered command-line apps.](https://github.com/infinitered/gluegun)[^4]**

标签：Node.js,TypeScript,Tools

和 Inquirer 类似，一个基于 TypeScript 的 Node.js 库，用来帮助开发命令行工具。从文档来看，API 相对比较简单。

![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130135003814.png)

**2、[GitHub - vercel/nft: Node.js dependency tracing utility](https://github.com/vercel/nft)[^5]**

标签：Tools,Node.js

一个 Node.js 的工具库，用来检测有哪些文件是 APP 运行时必须的（包括 node_modules 中的文件）。可以大大减小项目体积。

![](https://opengraph.githubassets.com/29811009321595cf6481572926d0428defb4de2c1228e3fb0c8b1bed33fe8c56/vercel/nft)

**3、[GitLab discovers widespread npm supply chain attack](https://about.gitlab.com/blog/gitlab-discovers-widespread-npm-supply-chain-attack/)[^6]**
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130135101899.avif)

**4、[A comprehensive guide to error handling In Node.js](https://www.honeybadger.io/blog/errors-nodejs/)[^7]**
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130141936144.png)

**5、[Electron vs. Tauri](https://www.dolthub.com/blog/2025-11-13-electron-vs-tauri/)[^8]**
...
![](https://raw.githubusercontent.com/Konata9/pic-base/main/pics/20251130141908054.webp)
